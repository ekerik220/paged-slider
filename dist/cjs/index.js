 ...
 */
var l$1=objectAssign,n$2=60103,p$1=60106;react_production_min.Fragment=60107;react_production_min.StrictMode=60108;react_production_min.Profiler=60114;var q$1=60109,r$2=60110,t$2=60112;react_production_min.Suspense=60113;var u$1=60115,v$1=60116;
if("function"===typeof Symbol&&Symbol.for){var w$1=Symbol.for;n$2=w$1("react.element");p$1=w$1("react.portal");react_production_min.Fragment=w$1("react.fragment");react_production_min.StrictMode=w$1("react.strict_mode");react_production_min.Profiler=w$1("react.profiler");q$1=w$1("react.provider");r$2=w$1("react.context");t$2=w$1("react.forward_ref");react_production_min.Suspense=w$1("react.suspense");u$1=w$1("react.memo");v$1=w$1("react.lazy");}var x$1="function"===typeof Symbol&&Symbol.iterator;
...
function O$1(a,b,c,e,d){var k=typeof a;if("undefined"===k||"boolean"===k)a=null;var h=!1;if(null===a)h=!0;else switch(k){case "string":case "number":h=!0;break;case "object":switch(a.$$typeof){case n$2:case p$1:h=!0;}}if(h)return h=a,d=d(h),a=""===e?"."+N$1(h,0):e,Array.isArray(d)?(c="",null!=a&&(c=a.replace(M$1,"$&/")+"/"),O$1(d,b,c,"",function(a){return a})):null!=d&&(L$1(d)&&(d=K$1(d,c+(!d.key||h&&h.key===d.key?"":(""+d.key).replace(M$1,"$&/")+"/")+a)),b.push(d)),1;h=0;e=""===e?".":e+":";if(Array.isArray(a))for(var g=
...
var t$1=React["undefined"!=typeof document&&void 0!==document.createElement?"useLayoutEffect":"useEffect"];var e$2 = t$1;

var n$1 = e=>{var a=react.exports.useRef(e);return react.exports.useEffect(()=>{a.current=e;}),a};
...
function e$1(){}var i$1,s$1="undefined"!=typeof window&&"ResizeObserver"in window?window.ResizeObserver:ResizeObserver;function r$1(r,u){var v,a,f=i$1||(v=new Map,a=new s$1(o$1((e,r)=>{for(var t=function(t){var n=v.get(e[t].target);null==n||n.forEach(n=>n(e[t],r));},n=0;n<e.length;n++)t(n);})),i$1={observer:a,subscribe(e,r){var t;a.observe(e);var n=null!==(t=v.get(e))&&void 0!==t?t:[];n.push(r),v.set(e,n);},unsubscribe(e,r){var t,n=null!==(t=v.get(e))&&void 0!==t?t:[];if(1===n.length)return a.unobserve(e),void v.delete(e);var o=n.indexOf(r);-1!==o&&n.splice(o,1),v.set(e,n);}}),c=n$1(u);return e$2(()=>{function t(e,r){n||c.current(e,r);}var n=0,o=r&&"current"in r?r.current:r;return o?(f.subscribe(o,t),()=>{n=1,f.unsubscribe(o,t);}):e$1},[r,f,c]),f.observer}

var useSize = (i,o)=>{var[f,n]=react.exports.useState(()=>{var t,r,e=i&&"current"in i?i.current:i;return e?[e.offsetWidth,e.offsetHeight]:[null!==(t=null==o?void 0:o.initialWidth)&&void 0!==t?t:0,null!==(r=null==o?void 0:o.initialHeight)&&void 0!==r?r:0]});return e$2(()=>{var t=i&&"current"in i?i.current:i;t&&n([t.offsetWidth,t.offsetHeight]);},[i]),r$1(i,t=>{var r=t.target;n([r.offsetWidth,r.offsetHeight]);}),f};
...
function useFeatures(props, visualElement, preloadedFeatures) {
    ...
    for (var i = 0; i < numFeatures; i++) {
        ...
        if (isEnabled(props) && Component) {
            features.push(react.exports.createElement(Component, __assign$1({ key: name_1 }, props, { visualElement: visualElement })));
        }
    }
    return features;
}
...
const a$1 = (a1, a2) => 1.0 - 3.0 * a2 + 3.0 * a1;
const b$1 = (a1, a2) => 3.0 * a2 - 6.0 * a1;
const c$1 = (a1) => 3.0 * a1;
const calcBezier = (t, a1, a2) => ((a$1(a1, a2) * t + b$1(a1, a2)) * t + c$1(a1)) * t;
const getSlope = (t, a1, a2) => 3.0 * a$1(a1, a2) * t * t + 2.0 * b$1(a1, a2) * t + c$1(a1);
            ...
            if (this.options.animate !== false &&
                ...
                this.addEventListener("didUpdate", function (_a) {
                    ...
                    if (((_d = _this.resumeFrom) === null || _d === void 0 ? void 0 : _d.instance) ||
                        ...
                        _this.startAnimation(__assign$1(__assign$1({}, getValueTransition(layoutTransition, "layout")), { onComplete: onLayoutAnimationComplete }));
                    }
                    else {
...
function createMotionComponent(_a) {
    ...
    function MotionComponent(props, externalRef) {
         ...
         */
        return (react.exports.createElement(VisualElementHandler, { visualElement: context.visualElement, props: __assign$1(__assign$1({}, config), props) },
            features,
...
function animateTarget(visualElement, definition, _a) {
    ...
    for (var key in target) {
        ...
        var animation = startAnimation(key, value, valueTarget, __assign$1({ delay: delay }, transition));
...
function MeasureLayout(props) {
    ...
    return (React.createElement(MeasureLayoutWithContext, __assign$1({}, props, { layoutGroup: layoutGroup, switchLayoutGroup: react.exports.useContext(SwitchLayoutGroupContext), isPresent: isPresent, safeToRemove: safeToRemove })));
}
...
function useMotionValue(initial) {
    ...
    if (isStatic) {
        var _a = __read(react.exports.useState(initial), 2), setLatest_1 = _a[1];
        react.exports.useEffect(function () { return value.onChange(setLatest_1); }, []);
    }
    return value;
}
...
function useSpring(source, config) {
    ...
    var isStatic = react.exports.useContext(MotionConfigContext).isStatic;
    var activeSpringAnimation = react.exports.useRef(null);
    ...
    react.exports.useMemo(function () {
        return value.attach(function (v, set) {
            ...
            activeSpringAnimation.current = animate$1(__assign$1(__assign$1({ from: value.get(), to: v, velocity: value.getVelocity() }, config), { onUpdate: set }));
            return value.get();
        });
...
var usePagedScroller = function () {
    var visibleContainerRef = react.exports.useRef(null);
    var itemsContainerRef = react.exports.useRef(null);
    var positionList = react.exports.useRef([]);
    var scrollLock = react.exports.useRef(false);
    var visibleContainerWidth = useSize(visibleContainerRef)[0];
    var itemsContainerWidth = useSize(itemsContainerRef)[0];
    var springDuration = 500;
    var xSpring = useSpring(0, { duration: springDuration });
    var x = useMotionValue(0);
    var _a = react.exports.useState(true), atStart = _a[0], setAtStart = _a[1];
    var _b = react.exports.useState(false), atEnd = _b[0], setAtEnd = _b[1];
    react.exports.useEffect(function () {
        var unsubscribeSpring = xSpring.onChange(function () { return x.set(xSpring.get()); });
        var unsubscribeX = x.onChange(function () {
            xSpring.set(x.get(), false);
            setAtStart(x.get() >= 0);
            setAtEnd(Math.abs(x.get()) >= itemsContainerWidth - visibleContainerWidth);
        });
        return function () {
            unsubscribeSpring();
            unsubscribeX();
    ...
    var updatePositionList = function (index, width, height, x, y) {
        positionList.current[index] = { width: width, height: height, x: x, y: y };
    };
    var setScrollLock = function () {
        ...
        setTimeout(function () { return (scrollLock.current = false); }, springDuration - 100);
    };
    var onLeftButtonClick = function () {
        ...
        var straddledPositionIndex = positionList.current.findIndex(function (item) {
            return Math.abs(xSpring.get()) > item.x &&
        ...
        var visibleAfterScrollIndex = straddledPositionIndex;
        if (straddledPositionIndex === -1) {
            var firstVisibleItemIndex = positionList.current.findIndex(function (item) { return item.x >= Math.abs(xSpring.get()); });
        ...
        var newPositionIndex = visibleAfterScrollIndex;
        for (var i = visibleAfterScrollIndex; i >= 0; i--) {
            if (i === 0) {
                newPositionIndex = 0;
                break;
            }
            var straddledPosition = positionList.current[visibleAfterScrollIndex];
            var positionDiff = Math.abs(straddledPosition.x +
    ...
    var onRightButtonClick = function () {
        ...
        var proposedNewOffset = -xSpring.get() + visibleContainerWidth;
        ...
        var straddledPosition = positionList.current.find(function (item) {
            return proposedNewOffset >= item.x && proposedNewOffset < item.x + item.width;
        });
    ...
    var onReturnToStartButtonClick = function () {
        if (scrollLock.current)
            return;
        setScrollLock();
        xSpring.set(0);
    ...
    return {
        ...
        onReturnToStartButtonClick: onReturnToStartButtonClick,
    };
};

var CellWrapper = function (_a) {
    var preventTaps = _a.preventTaps, updatePositionList = _a.updatePositionList, children = _a.children;
    var containerRef = react.exports.useRef(null);
    var _b = useSize(containerRef), width = _b[0], height = _b[1];
    react.exports.useEffect(function () {
        var _a, _b, _c, _d;
        var x = (_b = (_a = containerRef.current) === null || _a === void 0 ? void 0 : _a.offsetLeft) !== null && _b !== void 0 ? _b : 0;
        var y = (_d = (_c = containerRef.current) === null || _c === void 0 ? void 0 : _c.offsetTop) !== null && _d !== void 0 ? _d : 0;
        updatePositionList(width, height, x, y);
    }, [updatePositionList, width, height]);
    return (React.createElement("div", { ref: containerRef, style: { pointerEvents: preventTaps ? "none" : undefined } }, children));
};
...
var Button = function (_a) {
    ...
    return (React.createElement(ScrollButton, { type: type, "aria-label": ariaLabel, onClick: onClick }, react.exports.cloneElement(icon, { color: "white" })));
};
var positioned = {
    position: "absolute",
    top: "50%",
...
var leftPositioned = __assign$1(__assign$1({}, positioned), { left: 10 });
var rightPositioned = __assign$1(__assign$1({}, positioned), { right: 10 });
var overrideButtonStyle = te({
    variants: {
        side: {
            left: leftPositioned,
...
var PagedScroller = function (_a) {
    var _b = _a.width, width = _b === void 0 ? "100%" : _b, _c = _a.itemGap, itemGap = _c === void 0 ? 0 : _c, _d = _a.showArrows, showArrows = _d === void 0 ? !isTouchDevice() : _d, _e = _a.enableDrag, enableDrag = _e === void 0 ? isTouchDevice() : _e, _f = _a.dragElastic, dragElastic = _f === void 0 ? true : _f, scrollLeftButton = _a.scrollLeftButton, scrollRightButton = _a.scrollRightButton, returnToStartButton = _a.returnToStartButton, children = _a.children;
    var _g = usePagedScroller(), x = _g.x, visibleContainerRef = _g.visibleContainerRef, visibleContainerWidth = _g.visibleContainerWidth, itemsContainerRef = _g.itemsContainerRef, itemsContainerWidth = _g.itemsContainerWidth, atStart = _g.atStart, atEnd = _g.atEnd, updatePositionList = _g.updatePositionList, onLeftButtonClick = _g.onLeftButtonClick, onRightButtonClick = _g.onRightButtonClick, onReturnToStartButtonClick = _g.onReturnToStartButtonClick;
    var _h = react.exports.useState(false), dragging = _h[0], setDragging = _h[1];
    return (React.createElement(VisibleContainer, { ref: visibleContainerRef, css: { width: width, maxWidth: itemsContainerWidth } },
        React.createElement(React.Fragment, null,
            React.createElement(ItemsContainer, { ref: itemsContainerRef, css: { columnGap: itemGap }, drag: enableDrag ? "x" : false, dragConstraints: {
                    left: -itemsContainerWidth + visibleContainerWidth,
                    right: 0,
                }, _dragX: x, style: { x: x }, dragElastic: !dragElastic ? false : undefined, onDragStart: function () { return setDragging(true); }, onDragEnd: function () { return setDragging(false); } }, react.exports.Children.map(children, function (child, index) { return (React.createElement(CellWrapper, { preventTaps: dragging, updatePositionList: function (width, height, x, y) {
                    return updatePositionList(index, width, height, x, y);
                } }, child)); }))),
        showArrows && visibleContainerWidth !== itemsContainerWidth && (React.createElement(React.Fragment, null,
            !atStart && (React.createElement(Button, { type: "left", override: scrollLeftButton, onClick: onLeftButtonClick })),
            !atEnd ? (React.createElement(Button, { type: "right", override: scrollRightButton, onClick: onRightButtonClick })) : (React.createElement(Button, { type: "returnToStart", override: returnToStartButton, onClick: onReturnToStartButtonClick }))))));
};
var VisibleContainer = re("div", {
    position: "relative",
    overflow: "hidden",
});
var ItemsContainer = re(motion.div, {
    display: "inline-flex",
});

exports.PagedScroller = PagedScroller;
